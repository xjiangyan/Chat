...
import huiiuh.com.chat.addpter.InviteAdapter;
...
public class InviteActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        mLBM.registerReceiver(InviteChangedReceiver, new IntentFilter(AppConstant.CONTACT_INVITE_CHANGED));
        mLBM.registerReceiver(InviteChangedReceiver, new IntentFilter(AppConstant.GROUP_INVITE_CHANGED));
    }
